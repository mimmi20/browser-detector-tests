...
//            }
//        }
//        $company = $test->properties->RenderingEngine_Maker;
//
//        if (!isset($companies->$company)) {
//            $companies->$company = new stdClass();
//            $companies->$company->name = $company;
//            $companies->$company->brandname = $company;
//        }
//
//
//        $company = $test->properties->Browser_Maker;
//
//        if (!isset($companies->$company)) {
//            $companies->$company = new stdClass();
//            $companies->$company->name = $company;
...
//
//
//        $company = $test->properties->Platform_Maker;
//
//        if (!isset($companies->$company)) {
//            $companies->$company = new stdClass();
//            $companies->$company->name = $company;
...
//
//
//        $company = $test->properties->Device_Maker;
//
//        if (!isset($companies->$company)) {
//            $companies->$company = new stdClass();
//            $companies->$company->name = $company;
...
//
//
//        $company = $test->properties->Device_Brand_Name;
//
//        if (!isset($companies->$company)) {
//            $companies->$company = new stdClass();
//            $companies->$company->name = $company;
...
//        }
        ...
        if (!isset($browserTypes->$browserType)) {
            echo 'unknown Browser Type found: ', $browserType, PHP_EOL;
        }

        if (!isset($deviceTypes->$deviceType)) {
            echo 'unknown Device Type found: ', $deviceType, PHP_EOL;
        }
    }
...
file_put_contents(
    'vendor/mimmi20/browser-detector/data/companies.json',
    json_encode($companies, JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) . PHP_EOL
);
