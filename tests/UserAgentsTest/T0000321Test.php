 ...
 * @group      0000321
 */
class T0000321Test extends TestCase
{
    ...
    private $sourceDirectory = [
        'tests/issues/0000035/',
        'tests/issues/0000486/',
        'tests/issues/0000176/',
        'tests/issues/0000563/',
        'tests/issues/0000571/',
        'tests/issues/0000574/',
    ];
}
