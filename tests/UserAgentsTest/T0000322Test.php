 ...
 * @group      0000322
 */
class T0000322Test extends TestCase
{
    ...
    private $sourceDirectory = [
        'tests/issues/0002226/',
        'tests/issues/0000057/',
        'tests/issues/0000470/',
        'tests/issues/0000307/',
        'tests/issues/0000478/',
        'tests/issues/0000573/',
    ];
}
