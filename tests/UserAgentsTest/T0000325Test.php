 ...
 * @group      0000325
 */
class T0000325Test extends TestCase
{
    ...
    private $sourceDirectory = [
        'tests/issues/0000313/',
        'tests/issues/0000482/',
        'tests/issues/0000992/',
        'tests/issues/0000475/',
        'tests/issues/0000151/',
        'tests/issues/0000143/',
        'tests/issues/0000543/',
    ];
}
