 ...
 * @group      0000327
 */
class T0000327Test extends TestCase
{
    ...
    private $sourceDirectory = [
        ...
        'tests/issues/0000331/',
        'tests/issues/0000122/',
        'tests/issues/0000577/',
        'tests/issues/0000628/',
        'tests/issues/0000640/',
        'tests/issues/0000031/',
    ];
}
